...
export default function PrintButton({ label }: { label: string }) {
  return (
    <button
      ...
      className="print-hide inline-flex items-center gap-2 rounded border border-cream/15 px-3.5 py-2 font-mono text-meta text-text-subtle transition-colors hover:border-gold/50 hover:text-gold"
    >
