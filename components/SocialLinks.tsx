        ...
        return (
          <li key={s.label}>
            <a
              ...
              className="group inline-flex items-center gap-2 rounded border border-cream/15 px-3.5 py-2 text-sm text-text-muted transition-colors hover:border-gold/50 hover:text-gold"
            >
